//11. WAJP TO READ THE MONTH NUMBER FROM THE USER 
//AND PRINT CORRESPINDING MONTH NAME.

package programming;
import java.util.Scanner;
public class N11MonthNameFromMonthNumber {

	public static void main(String[] args) {
		Scanner sc=new Scanner(System.in);
		System.out.println("Enter month number to get its month name");
		int n=sc.nextInt();
			switch(n)
			{
